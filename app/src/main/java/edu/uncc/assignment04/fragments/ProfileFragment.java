...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.textViewRole.setText(mResponse.getRole());
        binding.textViewEdu.setText(mResponse.getEducation());
        ...
        binding.textViewIncomeValue.setText(mResponse.getIncome());
